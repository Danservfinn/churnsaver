...
- `SUPABASE_SERVICE_ROLE_KEY=<REDACTED> FROM SUPABASE DASHBOARD]` ⚠️ **NEEDS MANUAL INPUT**
- `DATABASE_URL=<REDACTED> ⚠️ **NEEDS PASSWORD**

**Cron Configuration**:
- `ENABLE_PG_BOSS=false`
- `CRON_SECRET=<REDACTED> (mark as Sensitive)
...
- `WHOP_API_KEY=<REDACTED> FROM WHOP DASHBOARD]` ⚠️ **NEEDS MANUAL INPUT**
- `WHOP_WEBHOOK_SECRET=<REDACTED> openssl rand -base64 32]` ⚠️ **NEEDS GENERATION**
